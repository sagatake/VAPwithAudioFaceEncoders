...
You can download pretrained models from [here](https://drive.google.com/drive/folders/1fX7USNGHYPzWhb9xzgylvshNwFW20-eZ?usp=sharing) and put those directories into `pretrained_models` directory.
